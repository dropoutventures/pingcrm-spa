export default {
    ...
    global: {
        ...
        inner: 'bg-white/5 formkit-disabled:bg-gray-200 formkit-disabled:cursor-not-allowed formkit-disabled:pointer-events-none',
        input: 'appearance-none bg-transparent focus:outline-none focus:ring-0 focus:shadow-none',
        label: 'block mb-1 font-medium text-sm text-gray-900 leading-6',
    ...
    'family:box': {
        decorator: 'block relative h-5 w-5 mr-2 rounded bg-white bg-gradient-to-b from-transparent to-gray-200 ring-1 ring-gray-300 peer-checked:ring-blue-500 text-transparent peer-checked:text-blue-500',
        ...
        label: '$reset text-sm text-gray-900 mt-1 select-none',
        wrapper: 'flex items-center mb-1',
    },
    'family:button': {
        input: '$reset inline-flex items-center bg-indigo-600 text-white text-sm font-normal py-3 px-6 rounded focus-visible:outline-2 focus-visible:outline-blue-600 focus-visible:outline-offset-2 formkit-disabled:bg-gray-400 formkit-loading:before:w-4 formkit-loading:before:h-4 formkit-loading:before:mr-2 formkit-loading:before:border formkit-loading:before:border-2 formkit-loading:before:border-r-transparent formkit-loading:before:rounded-3xl formkit-loading:before:border-white formkit-loading:before:animate-spin',
        wrapper: 'mb-1',
    ...
    'family:dropdown': {
        ...
        inner: 'relative flex ring-1 ring-gray-300 focus-within:ring-blue-500 focus-within:ring-2 rounded mb-1 formkit-disabled:focus-within:ring-gray-300 formkit-disabled:focus-within:ring-1 [&>span:first-child]:focus-within:text-blue-500',
        input: 'w-full px-3 py-2',
        listbox: 'bg-white shadow-lg rounded overflow-hidden',
        listboxButton: 'flex w-12 self-stretch justify-center mx-auto',
        listitem: 'pl-7 relative hover:bg-gray-300 data-[is-active="true"]:bg-gray-300 data-[is-active="true"]:aria-selected:bg-indigo-600 aria-selected:bg-indigo-600 aria-selected:text-white',
        loaderIcon: 'ml-auto',
    ...
    'family:text': {
        inner: 'flex items-center ring-1 ring-gray-300 focus-within:ring-blue-500 focus-within:ring-2 [&>label:first-child]:focus-within:text-blue-500 rounded mb-1',
        input: 'w-full px-3 py-2 border-none text-base text-gray-900 placeholder-gray-400',
    },
    'family:date': {
        inner: 'flex items-center ring-1 ring-gray-300 focus-within:ring-blue-500 focus-within:ring-2 [&>label:first-child]:focus-within:text-blue-500 rounded mb-1',
        input: 'w-full px-3 py-2 border-none text-gray-900 placeholder-gray-400',
    },
    ...
    select: {
        inner: 'flex relative items-center rounded mb-1 ring-1 ring-gray-300 focus-within:ring-blue-500 focus-within:ring-2 [&>span:first-child]:focus-within:text-blue-500',
        input: 'w-full pl-3 pr-8 py-2 border-none text-base text-gray-900 placeholder-gray-400 formkit-multiple:p-0 data-[placeholder="true"]:text-gray-400 formkit-multiple:data-[placeholder="true"]:text-inherit',
        selectIcon: 'flex p-[3px] shrink-0 w-5 mr-2 -ml-[1.5em] h-full pointer-events-none [&>svg]:w-[1em]',
        option: 'formkit-multiple:p-3 formkit-multiple:text-sm text-gray-700'
    },
    textarea: {
        inner: 'flex rounded mb-1 ring-1 ring-gray-300 focus-within:ring-blue-500 [&>label:first-child]:focus-within:text-blue-500',
        input: 'block w-full h-32 px-3 py-3 border-none text-base text-gray-900 placeholder-gray-400 focus:shadow-outline',
    },
    ...
    `,
      ...
      focus-visible:outline-none focus-visible:text-white focus-visible:bg-indigo-500
    `,
    ...
    slider: {
        ...
        fill: 'h-full rounded-full absolute top-0 mx-[-4px] bg-indigo-500',
    ...
    taglist: {
        ...
        tagWrapper: 'mr-1 focus:outline-none focus:text-white [&>div]:focus:bg-indigo-500 [&>div>button]:focus:text-white',
        tagLabel: 'pl-2 pr-1',
    ...
    toggle: {
        ...
        track: 'p-0.5 min-w-[3em] relative rounded-full transition-all bg-gray-400 peer-checked:bg-indigo-500 peer-checked:[&>div:last-child]:left-full peer-checked:[&>div:last-child]:-translate-x-full peer-checked:[&>div:first-child:not(:last-child)]:left-0 peer-checked:[&>div:first-child:not(:last-child)]:translate-x-0',
        valueLabel: 'font-bold text-sm',
        wrapper: 'flex flex-wrap items-center mb-1'
    },
    transferlist: {
        outer: `
      [&_.dnd-placeholder]:bg-indigo-500 [&_.dnd-placeholder]:text-white
    ...
    `,
        ...
        transferlistListItem: 'pl-8 relative aria-selected:bg-indigo-600 aria-selected:data-[is-active=true]:bg-indigo-600 aria-selected:text-white aria-selected:data-[is-active=true]:text-white first:-mt-px first:border-t py-2 px-3 flex relative border-b bg-white data-[is-active=true]:text-blue-500 data-[is-active=true]:bg-gray-100 cursor-pointer group-data-[is-max=true]:cursor-not-allowed items-center',
